...
MIDDLEWARE = [
    ...
    'sign_language_project.db_init_middleware.DatabaseInitMiddleware',  # Add database init middleware
    'sign_language_project.middleware.AutoLoginMiddleware',  # Auto-login middleware
